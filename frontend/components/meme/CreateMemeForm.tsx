            ...
            <div className="grid gap-8 mb-8 md:grid-cols-2">
                <div>
                    <div className="mb-6">
                        ...
                        <Input id="meme-title" placeholder="Enter a catchy title..." className="border-2 border-black" />
                    </div>

                    <div className="mb-6">
                        <Label htmlFor="meme-description" className="mb-2 text-lg font-bold">
                            Description
                        </Label>
                        <Textarea
                            id="meme-description"
                    ...
                    <div className="flex flex-col items-center justify-center p-6 mb-6 border-2 border-dashed border-black">
                        {memeImage ? (
                            <div className="relative w-full aspect-square max-w-xs mx-auto">
                                ...
                                />
                                <button
                                    className="absolute top-2 right-2 p-1 bg-white rounded-full border-2 border-black"
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-2 text-gray-600">Drag and drop your meme image here</p>
