    ...
    return (
        <div className="p-8 border-2 border-black">
            ...
            <div className="grid gap-8 mb-8 md:grid-cols-2">
                <div>
                    <div className="mb-6">
                        ...
                        <Input id="token-name" placeholder="e.g., DogeToken" className="border-2 border-black" />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <Input id="token-symbol" placeholder="e.g., DOGE" className="border-2 border-black" />
                    </div>

                    <div className="mb-6">
                        <Label className="mb-2 text-lg font-bold">Initial Supply</Label>
                        <div className="flex items-center gap-4">
                            <Slider defaultValue={[1000000]} max={10000000} step={100000} className="flex-1" />
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Slider defaultValue={[5]} max={10} step={0.5} className="flex-1" />
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 bg-accent border-2 border-black">
                        ...
                        <p className="text-gray-600">
                            Your token will be tradable on decentralized exchanges. Engagement rewards will distribute 2% of
                            supply to users who interact with your meme.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between">
                ...
                <Button onClick={handleMint} className="gap-2 bg-primary hover:bg-primary/90 hover:shadow-2xl" disabled={isMinting}>
                    {isMinting ? (
                        <>
